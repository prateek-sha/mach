...
if($_SERVER['REQUEST_METHOD']=='POST') 
    { 
        ...
        if ($row == FALSE){
            echo "falssssssssssssss";
        }
        else
        {
            $_SESSION['email'] = $User_object->email;
			header('Location: ../manu/product_list.php');
    ...
    <div class="container-login100" style="background-image: url('images/bg-01.jpg');">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
            <form class="login100-form validate-form"  method="POST">
                ...
                <div class="wrap-input100 validate-input m-b-20" data-validate="Enteremail">
                ...
                <div class="text-center">
                    <a href="manufacture-sign-up.php" class="txt2 hov1" style="text-decoration: none;">
                        <span style="color: rgb(41, 41, 41);">Don't have an account?</span> Sign Up
                    </a>
                </div>
            </form>
            ...
            <div class="row mb-5">
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2">Blurcraft</h2>
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon icon-map-marker"></span><span class="text">YOUR ADDRESS</span></li>
                                <li><a href="#"><span class="icon icon-phone"></span><span class="text">YOUR PHONE NUMBER HERE</span></a></li>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <p>
                        ...
                        </script> All rights reserved | This Website is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://www.linkedin.com/in/ritik-soni-x007/" target="_blank">Ritik</a>

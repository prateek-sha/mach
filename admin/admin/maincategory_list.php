      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">					
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="maincategory_list.php">Category List</a></li>			
						<li style="float:right;"><i class="fa fa-laptop"></i><a href="maincategory.php" >Add Category</a></li>
					</ol>
				</div>
			</div>
					...
					<tbody>
						...
						while($i<$count)
						{
							...
							<tr>
								...
								{
									echo "<a href='maincategory_active_status_change.php?id=".$row[$i]['id']."&status=0' >ON</a>";
								}
								else
								{
									echo "<a href='maincategory_active_status_change.php?id=".$row[$i]['id']."&status=1' >OFF</a>";
								}
								?>
								</td>
								<td>

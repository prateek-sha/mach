			  ...
			  <!-- <div class="row">
				<div class="col-lg-12">					
					<ol class="breadcrumb">
						...
						<li style="float:right;"><i class="fa fa-laptop"></i><a href="news.php" >Add News</a></li>
					</ol>
				</div>
			</div> -->
						...
						while($i<$count)
						{
							...
							<tr>
							 ...
							 <?php 
								if($row[$i]['status']==1)
								{
									echo "<a href='news_active_status_change.php?id=".$row[$i]['id']."&status=0' >ON</a>";
								}
								else
								{
									echo "<a href='news_active_status_change.php?id=".$row[$i]['id']."&status=1' >OFF</a>";
								}
								?>
								</td>
								<td>
								...
								<td>
									<div class="btn-group">				
									<a class="btn btn-success" href="news.php?id=<?php echo $row[$i]['id'];?>" >Edit</a>

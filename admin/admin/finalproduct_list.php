					...
					<tbody>
						...
						while($i<$count)
						{
							...
							<tr>
								...
								{
									echo "<a href='finalproducts_active_status_change.php?id=".$row[$i]['id']."&status=0' >ON</a>";
								}
								else
								{
									echo "<a href='finalproducts_active_status_change.php?id=".$row[$i]['id']."&status=1' >OFF</a>";
								}
								?>
								</td>							
								...
								<td>
									<div class="btn-group">				
									<a class="btn btn-success" href="finalproduct.php?id=<?php echo $row[$i]['id'];?>" >Edit</a>

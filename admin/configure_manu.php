...
//have check for both phn and mail otp
	...
	{
		$query = "SELECT * FROM Manufacture where ( email='".$this->email."'  or phonenumber='".$this->phonenumber."' or mobilenumber='".$this->mobilenumber."' ) and ( otpverified= '1')" ;
	...
	function getData()
	{
	  ...
	  function countData1()
	  {
		  $query = "SELECT count(id) count FROM Manufacture where  otpverified = '1' and emailverified ='1' ";

      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">					
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="enquiry_list.php">Enquiry List</a></li>			
					</ol>
				</div>
			</div>
				...
				?>
					...
					<thead>
						<tr>
							...
							<th><i class="icon_profile"></i> Message</th>
...
if(res==true)
{
window.location="delete_enquiry.php?id="+id;
}
}
    </script>

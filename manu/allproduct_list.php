      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">					
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="allproduct_list.php">All Products List</a></li>						
					</ol>
				</div>
			</div>
					...
					<tbody>
						...
						while($i<$count)
						{
							...
							<tr>
								...
								<td>
									<div class="btn-group">				
									<a class="btn btn-success" href="allproduct.php?id=<?php echo $row[$i]['id'];?>" >Add</a>									
									</div>
								</td>

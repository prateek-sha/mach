				...
				?>
					...
					<thead>
						<tr>
							...
							<th><i class="icon_profile"></i> Dispatch</th>
							<th><i class="icon_profile"></i> Upload Pdf</th>
						</tr>
					</thead>   
					...
					<tbody>
                        ...
                        $inbox_object->manu_id = $manuid;
						$row = $inbox_object->getRecordByManuId();
						...
						while($i<$count)
						{
							...
							<tr>
								...
								if($row[$i]['pdf'] == "hello")
								{
                                   echo " <button type='button' disabled class='btn btn-success' href='category_dispacted_status_change.php?id=".$row[$i]['id']."&status=1'>Dispatched</button> ";

									//echo "<a href='category_dispacted_status_change.php?id=".$row[$i]['id']."&status=0' >ON</a>";
								}
								else
								{
                                    echo " <a class='btn btn-success' href='category_dispacted_status_change.php?id=".$row[$i]['id']."&status=1'>Dispatched</a> ";
								}
								?>
								</td>
                                ...
                                <td>
									<div class="btn-group">				
									<a class="btn btn-success" href="uploadpdf.php?id=<?php echo $row[$i]['id'];?>" >Upload</a>
									</div>
								</td>
